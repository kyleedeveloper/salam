...
.setTitle("RetroBOT - Yardım Menüsü!")
...
client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539591' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539592' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539593' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539594' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539595' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539596' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
 ...
 client.on('messageCreate', async message => { 
  let guild = '1049381807063322634' //Tepkilerin oluşacağı sunucunun idsi 
  let channel = '1049381808514539597' //Tepkilerin oluşacağı kanalın idsi 
  let emoji1 = '✅' // İstediğiniz Emojiyi koyabilirsiniz
  let emoji2 = '❌' // İstediğiniz Emojiyi koyabilirsiniz
  if(message.channel.id === channel) {
  if(message.author.bot) return;
